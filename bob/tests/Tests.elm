...
tests =
    describe "Bob"
        [
          test "isYelling" <| \() -> Expect.equal True (Bob.isYelling "HELLO")
        , test "isYelling2" <| \() -> Expect.equal True (Bob.isYelling "HELLO?")
        , test "isYelling3" <| \() -> Expect.equal False (Bob.isYelling "4?")
        , test "isYelling4" <| \() -> Expect.equal False (Bob.isYelling "1, 2, 3")
